...
#include "M5Stack_4in8out_switch.h"

namespace esphome {
namespace M5Stack_4in8out {

static const char *const TAG = "switch.M5Stack_4in8out";

float M5Stack_4in8out_Switch::get_setup_priority() const { return setup_priority::HARDWARE; }

void M5Stack_4in8out_Switch::setup() {
  ESP_LOGCONFIG(TAG, "Setting up M5Stack_4in8out Switch '%s'...", this->name_.c_str());
...
void M5Stack_4in8out_Switch::dump_config() {
  LOG_SWITCH("", "M5Stack_4in8out Switch", this);
...
void M5Stack_4in8out_Switch::write_state(bool state) {
  ...
  this->parent_->outputWrite(this->channel_, state);
